"""
Django settings for nice_whisckers project.
...
SECRET_KEY = 'django-insecure-aut-@n7435+_s#)ewhjbvcz+ia_&3zb#adxnadnch1py2@fuk@'
...
WSGI_APPLICATION = 'nice_whisckers.wsgi.application'
